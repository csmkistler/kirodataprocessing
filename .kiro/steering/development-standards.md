...
- Leverage Browser MCP server to verify compatibility before adding dependencies
...
- Always check if there are existing files before creating new files
- If existing files exist, prioritise to reuse, amend and apend to existing file
